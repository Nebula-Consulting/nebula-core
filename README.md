# Nebula Core
 ...
 - Paste this onto the end of your My Domain URL: /packaging/installPackage.apexp?p0=04tQB000000Vrb7YAC
 - Include in your SFDX project as `"Nebula Core": "04tQB000000Vrb7YAC"`
...
Areas covered by the library:
  ...
  - [Conversions between SObjects and JSON structures](force-app/json/JSON.md)
  ...
  - Interfaces to help with common uses of the Strategy Pattern (Function, BooleanFunction, VoidFunction, etc.)
  - [Caching class for retrieving objects by Name](force-app/namedSObjectCache/NamedSObjectCache.md) e.g. configuration data stored in SObjects
  - [A callout-wrapper to make error-handling in callouts more consistent](force-app/callouts/Callouts.md)
  - [A builder class for building dynamic SOQL queries](force-app/queryBuilder/QueryBuilder.md)
  ...
  - An HttpCalloutMock which just throws an exception (see [Callouts](force-app/callouts/Callouts.md))
  - A class for pulling the details out of nested exceptions (StackTraces)
